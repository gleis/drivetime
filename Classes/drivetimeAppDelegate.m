...
#import "drivetimeAppDelegate.h"
#import "drivetimeViewController.h"
#import "tripDetailsViewController.h"

@implementation drivetimeAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	//	NSLog(@"plist missing");
		...
		if (!success){
			...
			NSString *path = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"settings.plist"];
